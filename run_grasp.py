...
file.write("seed,instance,rcl_size,iteration,cost,best_cost,best,iterations_since_last_min, iterations_since_best_cost, total_single_mins_found,probability,time_iteration,time\n")
file.close()
